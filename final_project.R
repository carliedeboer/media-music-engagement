...
# In this project, I’ll be using TuneFind’s Top 100 Songs of 2019 list merged with Spotify’s API to highlight common patterns behind the audio features of these songs as well as build a tool that can analyze a song for it’s “syncability”.
...
formula <- isSyncable ~ tempo + key + energy + valence + liveness + loudness + 
